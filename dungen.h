...
typedef struct s_dungeon {
	...
	void (*set_tile) (struct s_dungeon * this, const int x, const int y,
			  const t_tile tile);
...
typedef struct s_dungen {
	...
	int (*build_feature) (struct s_dungen * this, t_dungeon * dungeon,
			      const int x, const int y, const int xmod,
			      const int ymod, const t_direction direction);
	int (*build_corridor) (struct s_dungen * this, t_dungeon * dungeon,
			       const int x, const int y, const int max_len,
			       t_direction direction);
	int (*build_stairs) (struct s_dungen * this, t_dungeon * dungeon,
			     const t_tile tile);
} t_dungen;
